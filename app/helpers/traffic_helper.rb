...
module TrafficHelper
  ...
  def self.novelty_logo
    ...
    if time.month == 3 && time.day <= 7 && time.monday?
      ...
      return h.content_tag :style, "#logo { background: url(#{ActionController::Base.helpers.asset_path("code-logo-transparent.svg")}) no-repeat center, linear-gradient(180deg, #FE0000 16.66%, #FD8C00 16.66%, 33.32%, #FFE500 33.32%, 49.98%, #119F0B 49.98%, 66.64%, #0644B3 66.64%, 83.3%, #C22EDC 83.3%); }"
